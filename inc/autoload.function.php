...
function __s($str, $domain='glpi') {
   return htmlentities(__($str, $domain), ENT_QUOTES, 'euc-kr');
}
...
function _sx($ctx, $str, $domain='glpi') {
   return htmlentities(_x($ctx, $str, $domain), ENT_QUOTES, 'euc-kr');
}
...
function _sn($sing, $plural, $nb, $domain='glpi') {
   ...
   return htmlentities(_n($sing, $plural, $nb, $domain), ENT_QUOTES, 'euc-kr');
}
