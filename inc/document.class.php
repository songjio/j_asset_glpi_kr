...
//       $options['formoptions'] = " enctype='multipart/form-data'";
      ...
      if ($ID > 0) {
         ...
         echo "<input type='hidden' name='current_filepath' value='$docid'>";
      ...
      /////////////////////////////////////////////////////////////////////////
      	$org=$this->fields["mime"];
      	$docid = $this->fields["id"];      	 
      	$indexlen  = strpos($org, "/");
      	$resultstr = substr($org,0,$indexlen);
      if ($ID > 0&&$resultstr  == "image") {      		
      		echo "<tr class='tab_bg_1'>";
      		echo "<td>".__('Preview')."</td>";
      		echo "<td colspan='3'>";
      		echo "<img src='http://localhost/asset_glpi/front/document.send.php?docid=$docid'>";
      		echo "</td></tr>";
      }
      ////////////////////////////////////////////////////////////////////////
